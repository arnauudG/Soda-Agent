...
locals {
  ...
  # Extract region from path: env/prod/eu-west-1/addons/soda-agent
  # Path structure: [env, prod, eu-west-1, addons, soda-agent]
...
inputs = {
  ...
  chart_version = "1.3.13"  # Pinned to available stable version (released 2026-01-07)
