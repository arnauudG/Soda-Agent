...
locals {
  ...
  # Extract region from path: env/dev/eu-west-1/database/rds-collibra-dq/rds
...
inputs = {
  ...
  performance_insights_enabled     = false  # Dev: disable for cost savings
  monitoring_interval             = 0      # Dev: disable enhanced monitoring
