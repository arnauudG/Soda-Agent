# env/stack/addons/collibra-dq-standalone/alb/sg-alb/terragrunt.hcl
...
inputs = {
  ...
  # Egress rules - allow traffic to Collibra DQ instance (port 9000 = DQ Web, 9101 = health check)
  egress_with_cidr_blocks = [
    ...
    },
    {
      ...
      to_port     = 9101
      protocol    = "tcp"
      description = "Allow ALB health checks to Collibra DQ Agent (port 9101)"
      cidr_blocks = dependency.vpc.outputs.vpc_cidr_block
    }
  ]
